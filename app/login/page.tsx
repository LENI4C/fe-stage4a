...
export default function LoginPage() {
    ...
    const handleEmailAuth = async (e: React.FormEvent) => {
        ...
        try {
            const supabase = createClient();
            if (isSignUp) {
                // Use current origin - Supabase will handle the redirect based on configured URLs
    ...
    return (
        <div
            className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 px-4"
            role="main"
        >
            <div className="w-full max-w-md space-y-6 sm:space-y-8 rounded-2xl bg-white/10 backdrop-blur-lg p-6 sm:p-8 shadow-2xl ring-1 ring-white/20">
                <div className="text-center">
                    ...
                    <p className="text-white/80">
                        Join the collaborative 3D world
                    </p>
                </div>
