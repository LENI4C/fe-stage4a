...
export async function updateSession(request: NextRequest) {
  ...
  if (!supabaseUrl || !supabaseAnonKey) {
    // During build, env vars might not be available, just continue
  ...
  // Allow access to login and auth pages
  ...
  // complete the request and it will be stuck loading forever.
